...
const DDX = {
    hagma: [
        ...
        { name: 'Metformin-associated Lactic Acidosis', detail: 'Metformin + renal impairment, lactic acidosis', tags: ['drug', 'lactate', 'renal'], category: 'Toxins', clues: { lactatElevated: true, renal: true } },
    ...
    nagma: [
        ...
        { name: 'Renal Tubular Acidosis Type 1 (Distal)', detail: 'Unable to acidify urine, urine pH > 5.5, hypokalemia, nephrocalcinosis', tags: ['renal', 'RTA'], category: 'Renal', clues: { renal: true, potassium: 'low' } },
        { name: 'Renal Tubular Acidosis Type 2 (Proximal)', detail: 'Impaired proximal HCO3⁻ reabsorption, Fanconi syndrome', tags: ['renal', 'RTA'], category: 'Renal', clues: { renal: true, potassium: 'low' } },
    ...
    metAlk: [
        ...
        { name: 'Bartter Syndrome', detail: 'Autosomal recessive, mimics loop diuretic; normotensive', tags: ['genetic', 'chloride-resistant'], category: 'Chloride-Resistant (UCl > 20)', clues: { potassium: 'low' } },
        { name: 'Gitelman Syndrome', detail: 'Autosomal recessive, mimics thiazide; normotensive', tags: ['genetic', 'chloride-resistant'], category: 'Chloride-Resistant (UCl > 20)', clues: { potassium: 'low' } },
